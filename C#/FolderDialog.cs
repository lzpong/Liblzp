...
{
    /// <summary>
    /// 文件夹选择对话框(大窗口,类似文件选择对话框)
    /// </summary>
    internal class FolderDialog : IDisposable
    {
        ...
        //Vista 对话框
        internal DialogResult ShowVistaDialog(IWin32Window owner)
        {
        ...
        //传统对话框
        internal DialogResult ShowLegacyDialog(IWin32Window owner)
        {
